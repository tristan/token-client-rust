...
impl_array_struct!(ChainCode, u8, 32);
...
impl HDWallet {
    ...
    fn from_bip39(b: &Bip39) -> HDWallet {
        ...
        let chaincode = ChainCode::deserialize(&result[32..]);
    ...
    pub fn derive_path(&self, path: &str) -> Result<SecretKey,String> {
        ...
        chaincode.copy_from_slice(self.chain_code.as_ref());
...
mod tests {
    ...
    fn test_from_mnemonic() {
        ...
        assert_eq!(wallet.master_key.to_vec(),
