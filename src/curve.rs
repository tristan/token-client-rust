...
pub fn curve25519_verify(message: &[u8], public_key: &[u8;32], signature: &[u8;64]) -> bool {
...
mod tests {
    ...
    use super::crypto_sign_modified;
    use super::curve25519_verify;
    ...
    fn test_verify_sign() {
        ...
        macro_rules! run_test_case {
            ($msg:expr, $pk:expr, $sig:expr) => {
                ...
                let pk: [u8; 32] = $pk;
                let sig: [u8; 64] = $sig;
                assert!(curve25519_verify(&msg, &pk, &sig) == true);
            };
        }
